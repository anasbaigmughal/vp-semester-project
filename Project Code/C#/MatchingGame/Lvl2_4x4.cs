...
{
    public partial class Lvl2_4x4 : Form
    {
        static int time = 204;
        static int i = 0;
        ...
        private void CheckForWinner()
        {
            ...
            MessageBox.Show("LEVEL-2 PASSED! You matched all the icons!", "Congratulations!");
