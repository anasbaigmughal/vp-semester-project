...
{
    public partial class Lvl4_8x8 : Form
    {
        static int time = 480;
        static int i = 0;
        ...
        private void CheckForWinner()
        {
            ...
            MessageBox.Show("LEVEL-4 PASSED! You matched all the icons!", "Congratulations!");
