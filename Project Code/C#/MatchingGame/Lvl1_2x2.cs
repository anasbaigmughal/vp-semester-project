...
{
    public partial class Lvl1_2x2 : Form
    {
        static int time = 60;
        static int i = 0;
        ...
        private void CheckForWinner()
        {
            ...
            MessageBox.Show("LEVEL-1 PASSED! You matched all the icons!", "Congratulations!");
