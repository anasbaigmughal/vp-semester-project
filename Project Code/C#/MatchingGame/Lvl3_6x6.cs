...
{
    public partial class Lvl3_6x6 : Form
    {
        static int time = 360;
        static int i = 0;
        ...
        private void CheckForWinner()
        {
            ...
            MessageBox.Show("LEVEL-3 PASSED! You matched all the icons!", "Congratulations!");
